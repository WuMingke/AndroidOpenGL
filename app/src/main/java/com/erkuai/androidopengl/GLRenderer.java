 ...
 * <p>
 * 引入EGL
 * GLSurfaceView将OpenGL绑定到一起，也就是说GLSurfaceView一但销毁，伴随的OpenGL也一起销毁了，
 * 一个OpenGL只能渲染一个GLSurfaceView
 * <p>
 * OpenGL渲染的一般流程：
 * 线程创建
 * 获取显示设备
...
public class GLRenderer extends HandlerThread {
    ...
    public void render(Surface surface, int width, int height) {
        ...
        // 交换显存(将surface显存和显示器的显存交换,渲染的东西放到显示器去显示)
